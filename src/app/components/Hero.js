        ...
        >
          ...
          >
            ...
            >
              ...
              <motion.button
                disabled
                className="group bg-[#3A2A1E]/40 border-2 border-[#D4A017]/30 text-[#E8D5B5]/50 font-bold py-4 px-8 rounded-2xl text-lg w-full sm:w-auto flex items-center justify-center backdrop-blur-md relative overflow-hidden cursor-not-allowed"
              >
                <span className="relative z-10">Trade on Uniswap (Soon)</span>
                <motion.svg
      ...
      <style jsx>{`
        @media (max-width: 640px) {
          section {
            padding-top: 3.5rem;
            padding-bottom: 2rem;
            min-height: auto; /* Allow content to dictate height on mobile for compactness */
          }
        }
