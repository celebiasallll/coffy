...
export default function FutbolSimulatorPrivacyPage() {
    return (
        <div className="min-h-screen bg-gradient-to-b from-[#1A0F0A] via-[#2A1810] to-[#1A0F0A] text-white">
            <Navbar />
            <main className="container mx-auto px-6 py-24 max-w-4xl">
                <h1 className="text-4xl md:text-5xl font-bold mb-8 text-[#D4A017]">Privacy Policy for Futbol Menajerlik Simülatörü</h1>
                <div className="space-y-6 text-[#E8D5B5]/80 leading-relaxed">
                    <p className="italic">Last Updated: June 2026</p>
                    
                    <p>
                        At Futbol Menajerlik Simülatörü, we are committed to protecting your privacy. This Privacy Policy explains how we collect, use, and disclose information when you play our mobile game.
                    </p>
