...
contract CoffyCoin is ERC20, AccessControl, ReentrancyGuard, Pausable {
    ...
    // Remove mintForModule and burnFromModule functions and all references to them.
    // Only keep transferForModule for authorized modules.
    // Only crossChainModule can mint/burn via mintFromCrossChain and burnForCrossChain.
